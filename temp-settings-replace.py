...
# 5. ProfileTab replacement
new_profile_tab = """const ProfileTab = () => {
...
start_str = "// ─── TAB 1 — PROFIL (MA'LUMOTLAR) ────────────────────────────────────────────────\nconst ProfileTab = () => {"
end_str = "// ─── TAB 2 — XAVFSIZLIK VA EKSPORT ─────────────────────────────────────────────"

start_idx = content.find(start_str)
end_idx = content.find(end_str)

if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + "// ─── TAB 1 — PROFIL (MA'LUMOTLAR) ────────────────────────────────────────────────\\n" + new_profile_tab + "\\n\\n" + content[end_idx:]
