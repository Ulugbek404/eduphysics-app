...
export const lesson1 = {
    id: '9-l-20',
    chapter_id: '9-ch-02',
    title: 'Modda tuzilishining molekulyar-kinetik nazariyasi',
    ...
    content: {
        key_concepts: [
            'Molekula va atom tushunchalari',
            "Molekulyar-kinetik nazariyaning 3 ta asosiy qoidasi",
            'Browncha harakati',
            'Diffuziya hodisasi',
...
KEYINGI DARSDA: Molekulaning massasi va o'lchami — Avogadro soni, molyar massa, molekulalar sonini hisoblash.`,
        ...
        formulas: [
            {
                name: 'Molekula o\'lchami',
                formula: 'd \\approx 10^{-10} \\text{ m}',
                text: 'd ≈ 10⁻¹⁰ m',
                description: "Molekulaning taxminiy diametri",
                variables: [
                    { symbol: 'd', name: "Molekula diametri", unit: 'm' }
                ]
            }
        ],
        ...
        examples: [
            {
                title: "Atirning tarqalishi",
                problem: "Xonaning bir burchagida atr purkadingiz. Bir necha daqiqadan keyin butun xona hid bilan to'ldi. Bu qanday sodir bo'ldi?",
                given_data: { "Hodisa": "Atr bir burchakdan butun xonaga tarqaldi" },
                solution_steps: [
                    "Atr molekulalari havo molekulalari orasiga kiradi (diffuziya)",
                    "Havo molekulalari harakatda, ular atr molekulalarini urib turadi",
                    "Atr molekulalari tartibsiz harakat qilib, barcha tomonga tarqaladi",
                    "Oxir-oqibat butun xona bir xil konsentratsiyaga erishadi"
                ],
                solution: "Atr molekulalari havo molekulalari orasiga diffuziya orqali kiradi. Havo molekulalari harakatda bo'lgani uchun atr molekulalarini urib, ularni barcha tomonga harakatlantiradi. Natijada butun xona bir xil konsentratsiyaga erishadi.",
                answer: "Molekulalar tartibsiz harakati va diffuziya natijasida atr butun xonaga tarqaladi.",
                difficulty: 'easy'
            },
            {
                title: "Choyga shakar qo'shish",
                problem: "Choyga shakar qo'shdingiz. Bir necha daqiqadan keyin butun choy shirinlashdi, hatto aralashtirmasangiz ham! Bu qanday sodir bo'ldi?",
                given_data: { "Hodisa": "Shakar choyda aralashtirmasdan eridi" },
                solution_steps: [
                    "Shakar molekulalari suvda eriydi",
                    "Suv molekulalari shakar molekulalarini urib, ularni har tomonga harakatlantiradi",
                    "Shakar molekulalari barcha yo'nalishlarda tarqaladi (diffuziya)",
                    "Oxir-oqibat har qismda bir xil miqdorda shakar bo'ladi"
                ],
                solution: "Shakar molekulalari suvda erigandan keyin, suv molekulalari ularni urib har tomonga harakatlantiradi. Diffuziya natijasida shakar butun choyda bir xil tarqaladi.",
                answer: "Diffuziya orqali shakar butun choyda bir xil tarqaladi.",
                difficulty: 'easy'
            },
            {
                title: "Suv tomchisidagi chang (Browncha harakati)",
                problem: "Mikroskop ostida suv tomchisini ko'rsangiz, chang zarrachalari zigzag tarzda harakatlanadi. Bu nima?",
                given_data: { "Kuzatuv": "Chang zarrachalari zigzag harakatda" },
                solution_steps: [
                    "Suv molekulalari ko'zga ko'rinmaydi, lekin ular juda tez harakat qiladi",
                    "Ular chang zarrachasiga har tomondan uriladi",
                    "Urilishlar tasodifiy, shuning uchun zarrach zigzag harakat qiladi",
                    "Bu Browncha harakati deyiladi — Robert Brown 1827 yilda kashf etgan"
                ],
                solution: "Suv molekulalari chang zarrachasiga har tomondan tasodifiy uriladi. Har bir paytda turli tomondan ko'proq urilish bo'lgani uchun zarrach zigzag yo'l bo'ylab harakatlanadi.",
                answer: "Bu Browncha harakati — molekulalarning zarrachaga urilishi natijasida yuzaga keladi.",
                difficulty: 'medium'
            },
            {
                title: "Muzning erishi",
                problem: "Muzni xonaga qo'ysangiz, u eriydi. Bu jarayonni MKN nuqtai nazaridan tushuntiring.",
                given_data: { "Hodisa": "Muz xona haroratida eriydi" },
                solution_steps: [
                    "Muzda molekulalar qattiq bog'langan, faqat tebranadi",
                    "Xona havosi molekulalari muz molekulalariga energiya beradi",
                    "Muz molekulalari ko'proq energiya oladi va tezroq tebranadi",
                    "Tortishish kuchlarini yengib, erkin harakat qila boshlaydi",
                    "Muz suyuq holatga o'tadi (eriydi)"
                ],
                solution: "Xona harorati yuqori bo'lgani uchun havo molekulalari muz molekulalariga kinetik energiya beradi. Natijada muz molekulalari tezroq tebranib, o'zaro tortishish kuchlarini yengadi va erkin harakat qila boshlaydi — suyuq holatga o'tadi.",
                answer: "Havo molekulalaridan energiya olgan muz molekulalari tortishish kuchlarini yengib, suyuq holatga o'tadi.",
                difficulty: 'medium'
            }
        ]
    },
    ...
    questions: [
        ...
        },
        {
            ...
            correct: 1,
            explanation: "Browncha harakati — Robert Brown tomonidan 1827 yilda kashf etilgan hodisa. Suyuqlik yoki gazdagi kichik zarrachalar molekulalar tomonidan urilgani uchun tartibsiz harakat qiladi.",
            difficulty: 'medium'
        },
        {
            id: 3,
            ...
            correct: 2,
            explanation: "Gazlarda molekulalar eng erkin va tez harakat qilgani uchun diffuziya eng tez bo'ladi. Qattiq jismlarda esa eng sekin (yillar davom etishi mumkin).",
            difficulty: 'medium'
        },
        {
            id: 4,
            question: "Molekulyar-kinetik nazariyani kim asoslagan?",
            options: ["Isaak Nyuton", "Albert Eynshteyn", "Mixail Lomonosov", "Galileo Galiley"],
            correct: 2,
            explanation: "Rus olimi M.V. Lomonosov (1711-1765) molekulyar-kinetik nazariyaning asoschisi hisoblanadi. U 1748 yilda bu g'oyani ilmiy asosladi.",
            difficulty: 'easy'
        },
        {
            id: 5,
            question: "Molekulalar o'rtasida qanday kuchlar mavjud?",
            options: [
                "Faqat tortishish kuchlari",
                "Faqat itarish kuchlari",
                "Tortishish va itarish kuchlari",
                "Hech qanday kuch yo'q"
            ],
            correct: 2,
            explanation: "Molekulalar o'rtasida ham tortishish (molekulalarni yaqinlashtiruvchi), ham itarish (molekulalarni uzoqlashtiruvchi) kuchlari mavjud. Bu ikki kuchning nisbati moddaning holatini belgilaydi.",
            difficulty: 'medium'
        }
    ]
};
