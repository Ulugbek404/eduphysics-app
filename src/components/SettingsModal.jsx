...
import { Settings, User, Info, Smartphone, Moon, Sun, Monitor, Volume2, VolumeX, X, Palette, Atom, Camera, Sparkles } from 'lucide-react';
                    ...
                    <div className="max-w-xl mx-auto pt-6">
                        ...
                        {activeTab === 'general' && (
                            <div className="space-y-8 animate-fadeIn">
                                ...
                                <section>
                                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-blue-400">
                                        <Sparkles size={20} /> AI Sozlamalari
                                    </h3>
                                    <div className="bg-slate-800 p-4 rounded-xl border border-slate-700">
                                        <label className="block text-sm font-medium text-slate-400 mb-2">Google Gemini API Kaliti</label>
                                        ...
                                        <p className="text-xs text-slate-500 mt-2">AI test tuzish va laboratoriya tahlili uchun kerak.</p>
                                    </div>
                                </section>
                            </div>
                        )}
